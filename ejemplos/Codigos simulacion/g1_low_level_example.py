...
# @date 2025-09-21
# @version 1.0
# @brief Ejemplo de control bajo nivel de G1 en simulación
#
# @descripcion
#   Este script demuestra cómo enviar comandos LowCmd al robot G1
#   dentro del simulador Unitree Mujoco. Ejecuta una secuencia de movimeinto de tobillos y muñecas del robot.
#
# @requisitos
