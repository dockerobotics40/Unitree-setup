...
# -----------------------------------------------------------------------------
    ...
    - Versión G1 23DoF sin manos, con cinco articulaciones por brazo y un eje de cintura.

    @uso
        python3 g1_arm_sdk_moveV5.py <nombreInterfaz> 
...
class G1JointIndex:
    ...
    # Slot de ponderación de arm_sdk; no corresponde a un motor físico.
    kNotUsedJoint = 29
